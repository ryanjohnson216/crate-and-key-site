...
import { HERO_PHOTO_DATA_URI } from "../assets/heroPhotoData";
  ...
  return (
    <section className="relative w-full overflow-hidden bg-[#FDFBF7] pt-4 sm:pt-8 lg:pt-12 pb-8 sm:pb-16 lg:pb-20 border-b border-[#EBE3D5]/60">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-6 sm:gap-8 lg:gap-8 xl:gap-12">
          ...
          <div className="flex-1 text-left space-y-4 sm:space-y-6">
            ...
            {/* CTA Button */}
            <div className="flex items-center justify-start pt-1 sm:pt-2 w-full text-left">
              <button
                type="button"
          ...
          {/* Right Column: Hero Photo (Embedded Base64 Data URI for 100% reliable production rendering) */}
          <div className="w-full sm:w-auto shrink-0 flex justify-center lg:justify-end items-center">
            <div className="relative rounded-2xl overflow-hidden shadow-sm border border-[#EBE3D5] bg-[#F3EFE6] w-full max-w-[350px] sm:max-w-[420px] lg:w-[420px] lg:h-[420px] xl:w-[460px] xl:h-[460px] aspect-square">
              <img
                src={HERO_PHOTO_DATA_URI}
                alt="Crate & Key heavy duty plastic totes delivered at front door"
                className="w-full h-full object-cover transition-transform duration-500 hover:scale-[1.02]"
                onError={(e) => {
                  // Secondary fallback if ever needed
                  (e.target as HTMLImageElement).src = "/square-hero-front-door.jpg";
                }}
              />
            </div>
          </div>
